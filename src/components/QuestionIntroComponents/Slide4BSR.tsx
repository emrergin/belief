	...
	return (
		<Carousel.Slide>
			...
			>
				<List.Item>
					{" "}
					Kararınızı belirttikten sonra, eğer ekrandaki cümle aslında{" "}
					<b className={circleStyles.redText}>yanlış</b> idiyse{" "}
					<b className={circleStyles.redText}>kırmızı</b> simit,{" "}
					<b className={circleStyles.blueText}>doğru</b> idiyse{" "}
					<b className={circleStyles.blueText}>mavi</b> simit ekranda kalacak,
