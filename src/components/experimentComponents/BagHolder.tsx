...
function BagHolder({ aBlue, bBlue, diceText, showBalls=true }: { aBlue: number; bBlue: number; diceText:[String,String]; showBalls?:boolean }) {
	return (
		<div className={customStyles.bagHolder}>
			<div>
				...
				{showBalls && <div className={customStyles.ballHolder}>
					{[...Array(bBlue)].map((e, i) => (
						<div key={i}>🔵 </div>
					))}
